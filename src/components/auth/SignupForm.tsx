...
export const SignupForm: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex">
        ...
        >
          ...
          <div className="text-center">
            <div className="flex items-center justify-center gap-3 mb-6">
              <div className="w-12 h-12 flex items-center justify-center">
                <svg width="48" height="48" viewBox="0 0 503 567" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="space-y-4">
            <Button
              variant="glass"
              size="lg"
              className="w-full justify-center gap-3 py-4 text-base font-medium border-white/20 hover:border-white/30"
      ...
      <div className="flex-1 bg-white/[0.02] backdrop-blur-md border-l border-white/10 flex items-center justify-center p-8">
        <motion.div
          initial={{ opacity: 0, x: 50 }}
          animate={{ opacity: 1, x: 0 }}
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Start your startup journey today</p>
          </div>

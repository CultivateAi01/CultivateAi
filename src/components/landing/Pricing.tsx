  ...
  return (
    <section id="pricing" className="py-32 px-6 relative">
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        {/* Main Pricing Card - REMOVED (opacity: 0) */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <div className="relative bg-transparent border-transparent rounded-3xl p-12" style={{ opacity: 0 }}>
            ...
            {/* Plans grid - now directly in section without card wrapper */}
            <motion.div
          ...
          {plans.map((plan, index) => {
            ...
            return (
              <motion.div
                ...
                transition={{ duration: 0.5, delay: 0.7 + index * 0.1 }}
                viewport={{ once: true }}
                className={`relative flex flex-col p-6 bg-white/[0.03] backdrop-blur-sm border border-white/[0.08] rounded-xl hover:bg-white/[0.06] transition-all duration-300 group ${
                  plan.popular ? 'ring-1 ring-white/20' : ''
                }`}
              >
                {plan.popular && (
        ...
        <motion.div
          ...
          transition={{ duration: 0.6, delay: 1 }}
          viewport={{ once: true }}
          className="flex flex-col md:flex-row items-center justify-center gap-8 pt-8 border-t border-white/10 mb-8"
        >
          {[
            { number: '10,000+', label: 'Active users', icon: '👥' },
            { number: '50,000+', label: 'Ideas validated', icon: '💡' },
        ...
        {/* Bottom guarantee text - now directly in section */}
